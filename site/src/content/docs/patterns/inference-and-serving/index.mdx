...
<CardGrid>
  <LinkCard
    ...
    href="/AI-Engineering-Patterns/patterns/inference-and-serving/llm-gateway/"
  />
  <LinkCard
    title="Model Router"
    description="Route queries to cheap/fast models vs powerful ones based on complexity for 85-99% cost reduction."
    href="/AI-Engineering-Patterns/patterns/inference-and-serving/model-router/"
  />
  <LinkCard
    ...
    href="/AI-Engineering-Patterns/patterns/inference-and-serving/semantic-caching/"
  />
</CardGrid>
